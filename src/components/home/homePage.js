  ...
  return (
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-md-6">
                ...
                <p className="right italic bold"><b>Founded by<br/>-Paul Harris</b></p>
                <p><a href="#works" className="btn btn-primary text-white px-5 left margin-bottom scrollLink">Our works</a></p>
              </div>
              <div className="col-md-6">
    ...
    <div className="site-section bg-white" id="collaborations">
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 mb-4" style={{height: "auto"}}>
            <div className="post-entry-1 h-100" style={{height: "auto"}}>
              <div style={{width: "100%"}} className="center">
                <img src={rotract} alt="Image" className="img-fluid"/>
              </div>
              <div className="post-entry-1-contents center" style={{height: "auto"}}>
                <h2><a>Rotaract Club Of Kalwan</a></h2>
                <span className="meta d-inline-block mb-3">July 17, 2019  </span>
