...
const Header = (props) => {
  ...
  useEffect(() => {
    ...
    if (window.location.pathname === "/") {
      ...
      setContent(<h1 className="mb-4 text-white">Our Work</h1>);
    }
  }, []);

  const LogOut = () => {
    props.actions.removeUserDetail();
    return <div>{toast.success("LogOut Success")}</div>;
  };
      ...
      <div>
        ...
        >
          <Navbar bg="" className=" mb-3 container">
            <Container fluid>
              <Navbar.Brand href="#" className="site-logo font-gray-1">
                <b>Rotary.</b>
              </Navbar.Brand>
          ...
          <div className="container" style={{ zIndex: "1" }}>
            <div className="row align-items-center justify-content-center">
              <div className="col-md-7 text-center page-header ">{content}</div>
            </div>
          </div>
        </div>
      </div>
